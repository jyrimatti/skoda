...
#! nix-shell --pure --keep XDG_RUNTIME_DIR --keep SKODA_USER --keep SKODA_PASSWORD -i dash -I channel:nixos-23.11-small -p dash cacert curl jq yq htmlq flock gnugrep gnused findutils
set -eu
